...
namespace Wiki {
    ...
    template <typename RandomAccessIterator, typename Comparison, typename CancelTest>
    void Sort(RandomAccessIterator first, RandomAccessIterator last, Comparison compare, CancelTest isCanceled) {
